...
GOOGLE_API_KEY = "f80fd476-a44b-46fd-9218-c1d6ce7e35a4"
CUSTOM_SEARCH_ENGINE_ID = "auorora-1743163807274"  # Use your actual CSE ID
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY")  # Or set this similarly if available
